...
function ajaxFileUpload() {
	var uploadType = $("#uType option:selected").val();
...
<tbody>
<c:forEach items="${lst_file}"  var = "ite">
  <tr>
...
<div class="yxbox">
    ...
    <div class="pd15">
    	<form name="uploadForm" id="upload_form"  action="#" method="post" enctype="multipart/form-data">
    		<span>上传类型：</span>
    		<select name="uploadType" id="uType">
    			<option value="">--请选择--</option>
    			<option value="1">内网上传</option>
    			<option value="2">外网上传</option>
    		</select>
